      ...
      <div className="carousel w-full">
        <div id="slide1" className="carousel-item relative w-full">
          <div className="flex justify-center w-full gap-4">
            ...
            <div className="text-center outline outline-offset-2 outline-yellow-400 bg-white flex flex-col my-2 justify-center gap-4 w-1/2 rounded-3xl px-4 ">
              <h1 className="text-4xl font-bold">Kepala (Head)</h1>
              <p className="text-2xl font-semibold">
                Bagian utama tubuh yang mengandung otak, mata, telinga, hidung,
                dan mulut.
              </p>
              <button
                onClick={() => {
                  const audio = new Audio("/audio/kepala.mp3");
                  audio.play();
                }}
        ...
        <div id="slide2" className="carousel-item relative w-full">
          <div className="flex justify-center w-full gap-4">
            ...
            <div className="text-center outline outline-offset-2 outline-yellow-400 bg-white flex flex-col my-2 justify-center gap-4 w-1/2 rounded-3xl px-4 ">
              ...
              <button
                onClick={() => {
                  const audio = new Audio("/audio/rambut.mp3");
                  audio.play();
                }}
                className="w-max mx-auto bg-yellow-400 p-2 rounded-full hover:bg-yellow-600 hover:scale-110 transition-all duration-300"
              >
        ...
        <div id="slide3" className="carousel-item relative w-full">
          <div className="flex justify-center w-full gap-4">
            <img src="/mata.png" />
            <div className="text-center outline outline-offset-2 outline-yellow-400 bg-white flex flex-col my-2 justify-center gap-4 w-1/2 rounded-3xl px-4 ">
              <h1 className="text-4xl font-bold">Mata (eyes)</h1>
              <p className="text-2xl font-semibold">Organ untuk melihat.</p>
              <button
                onClick={() => {
                  const audio = new Audio("/audio/mata.mp3");
                  audio.play();
                }}
                className="w-max mx-auto bg-yellow-400 p-2 rounded-full hover:bg-yellow-600 hover:scale-110 transition-all duration-300"
              >
        ...
        <div id="slide4" className="carousel-item relative w-full">
          <div className="flex justify-center w-full gap-4">
            <img src="/hidung.png" />
            <div className="text-center outline outline-offset-2 outline-yellow-400 bg-white flex flex-col my-2 justify-center gap-4 w-1/2 rounded-3xl px-4 ">
              <h1 className="text-4xl font-bold">Hidung (Nose)</h1>
              <p className="text-2xl font-semibold">
                Digunakan untuk bernapas dan mencium bau.
              </p>
              <button
                onClick={() => {
                  const audio = new Audio("/audio/hidung.mp3");
                  audio.play();
                }}
                className="w-max mx-auto bg-yellow-400 p-2 rounded-full hover:bg-yellow-600 hover:scale-110 transition-all duration-300"
              >
        ...
        <div id="slide6" className="carousel-item relative w-full">
          <div className="flex justify-center w-full gap-4">
            <img src="/mulut.png" />
            <div className="text-center outline outline-offset-2 outline-yellow-400 bg-white flex flex-col my-2 justify-center gap-4 w-1/2 rounded-3xl px-4 ">
              <h1 className="text-4xl font-bold">Mulut (mouth)</h1>
              <p className="text-2xl font-semibold">
                Digunakan untuk berbicara, makan, dan bernapas.
              </p>
              <button
                onClick={() => {
                  const audio = new Audio("/audio/mulut.mp3");
                  audio.play();
                }}
                className="w-max mx-auto bg-yellow-400 p-2 rounded-full hover:bg-yellow-600 hover:scale-110 transition-all duration-300"
              >
        ...
        <div id="slide7" className="carousel-item relative w-full">
          <div className="flex justify-center w-full gap-4">
            ...
            <div className="text-center outline outline-offset-2 outline-yellow-400 bg-white flex flex-col my-2 justify-center gap-4 w-1/2 rounded-3xl px-4 ">
              <h1 className="text-4xl font-bold">Alis (eyebrow)</h1>
              <p className="text-2xl font-semibold">
                Rambut di atas mata yang melindungi mata dari keringat dan
                kotoran.
              </p>
              <button
                onClick={() => {
                  const audio = new Audio("/audio/alis.mp3");
                  audio.play();
                }}
                className="w-max mx-auto bg-yellow-400 p-2 rounded-full hover:bg-yellow-600 hover:scale-110 transition-all duration-300"
              >
